...
public class CamundaServicee {
    ...
    private final String CAMUNDA_RUN_URL ;

    private final RestTemplate restTemplate;

    // Injection de la propriété camunda.rest-url via le constructeur
    public CamundaServicee(@Value("${camunda.rest-url}") String camundaRunUrl) {
        this.CAMUNDA_RUN_URL = camundaRunUrl;
