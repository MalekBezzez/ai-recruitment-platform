        ...
        http.csrf(csrf -> csrf.disable())
               // .cors(cors -> cors.configurationSource(corsConfigurationSource()))
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/conge/**").authenticated().requestMatchers("/prediction/save-result/**").permitAll()
                        .requestMatchers("/notifications/events/**").permitAll()
                        .requestMatchers("/prediction/**").permitAll()
                        .requestMatchers("/api/employee-skill/**").permitAll()
                        .requestMatchers("/historyleaves/**").authenticated()
                        .requestMatchers("/nlp/**").authenticated().requestMatchers("/answers/**").authenticated()
                        ...
                        .requestMatchers("/results/**").authenticated().requestMatchers("/questionnaires/**").authenticated()
                        .requestMatchers("/photos/**").authenticated()
                        .requestMatchers("/payslips/**").authenticated().requestMatchers("/channels/**").authenticated()
