...
public class CoachingSession {
    ...
    @Column(name = "coach_justification", columnDefinition = "TEXT")
    private String coachJustification;

    @ManyToOne
    @JoinColumn(name = "coach_id")
    private Employe coach;
    ...
    @ManyToMany
    @JoinTable(
            name = "coaching_session_employee",
            joinColumns = @JoinColumn(name = "coaching_session_id"),
