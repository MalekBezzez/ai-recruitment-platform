...
const handleSnackClose = (_, reason) => {
  ...
  const handleStartRecommendation = async () => {
    ...
    try {
      await axios.post(
        `${API_URL}/api/employee-skill/process`,
        {
      ...
      setSelectedIds([]);
      navigate("/training-recommendation-plan");
    } catch (err) {
...
export default DecisionJobOffer;
